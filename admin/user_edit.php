...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi, "UPDATE dt_user SET password='$password', level='$level' WHERE id_user='$id_user'");
		...
		$sql = mysqli_query($koneksi, "SELECT * FROM dt_user WHERE id_user='$id_user'");
...
<form method="post" action="" class="form-horizontal" role="form">
	...
	<div class="form-group">
		<label for="jenis" class="col-sm-2 control-label">Ubah Jenis User</label>
		<div class="col-sm-3">
